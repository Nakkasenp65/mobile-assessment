          ...
          <div className="container mx-auto">
            <div className="rounded-xl bg-white p-4 shadow-xl sm:p-6">
              ...
              <div className="mb-4 text-center sm:mb-6">
                ...
                <div className="mx-auto mt-2 h-1.5 w-20 rounded-full bg-gradient-to-r from-orange-400 to-pink-400 sm:w-28" />
              </div>
              ...
              <div className="grid grid-cols-2 gap-x-2 gap-y-4 sm:gap-5 lg:grid-cols-4 lg:gap-8">
                {featuresData.map((feature, index) => (
                  ...
                  >
                    ...
                    {/* Text Content */}
                    <h3 className="bg-gradient-to-r from-orange-500 to-pink-500 bg-clip-text text-xs font-bold text-transparent sm:text-lg">
                      {feature.title}
                    </h3>
