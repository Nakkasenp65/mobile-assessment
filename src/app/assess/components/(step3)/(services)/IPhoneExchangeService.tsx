...
const IPhoneExchangeService = ({ service, theme, isSelected }: IPhoneExchangeServiceProps) => {
  ...
  // This prevents latent state by resetting irrelevant fields, ensuring data consistency.
      ...
      <AccordionContent className="px-4 pb-4">
        <div className="mt-2 space-y-6 border-t pt-4 dark:border-zinc-700/50">
          ...
          >
            ...
            {/* Step 2: Location Selection & Details */}
            <motion.div variants={formVariants} className="space-y-4">
