...
const InputPhoneNumber: React.FC<InputPhoneNumberProps> = ({
  ...
  return (
    // Container
    <div className="h-max w-full max-w-xl items-center justify-center rounded-2xl bg-white p-8 shadow-xl">
      {/* Heading */}
      <div className="flex flex-col items-center gap-2">
        ...
        <h1 className="mt-4 text-center text-xl font-bold tracking-tight text-gray-900">ตรวจสอบรายการประเมินของคุณ</h1>

        <p className="text-center text-sm text-gray-600 md:text-lg">OK Mobile : บริษัท โอเค นัมเบอร์ วัน จำกัด</p>
      </div>

      {/* Form */}
      <form onSubmit={onSubmit} className="mt-10 w-full rounded-2xl bg-white">
      ...
      {isDevEnv && (
        <div className="mt-6 flex items-center justify-center gap-2 rounded-lg p-2 text-sm font-medium text-black uppercase">
